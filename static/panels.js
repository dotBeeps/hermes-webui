...
async function _autosaveAppearanceSettings(payload){
  try{
    ...
    const savedAppearance=Object.assign({},payload,saved||{});
    _settingsAppearanceAutosaveRetryPayload=null;
    _rememberAppearanceSaved(savedAppearance);
    if(savedAppearance&&savedAppearance.font_size){
      localStorage.setItem('hermes-font-size',savedAppearance.font_size);
    }
    if(saved){
